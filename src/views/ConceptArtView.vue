...
const introCarouselRef = ref<HTMLElement | null>(null)

const scrollIntroLeft = () => {
  if (introCarouselRef.value) {
    introCarouselRef.value.scrollBy({ left: -400, behavior: 'smooth' })
  }
}

const scrollIntroRight = () => {
  if (introCarouselRef.value) {
    introCarouselRef.value.scrollBy({ left: 400, behavior: 'smooth' })
  }
}
...
<template>
  <section class="concept-art-section grain">
    ...
    <div class="intro-container">
      ...
      <!-- Intro Videos Carousel -->
      <div class="intro-videos-carousel-container reveal d-4">
        <!-- Carousel Prev Arrow -->
        <button class="intro-carousel-arrow prev" @click="scrollIntroLeft" aria-label="Previous">
        ...
        <!-- Carousel Next Arrow -->
        <button class="intro-carousel-arrow next" @click="scrollIntroRight" aria-label="Next">
          <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2.5" fill="none" stroke-linecap="round" stroke-linejoin="round">
...
/* Intro Videos Carousel */
.intro-videos-carousel-container {
  position: relative;
  max-width: 1200px;
  margin: 3rem auto 0;
  z-index: 20;
...
.intro-videos-scroll::-webkit-scrollbar {
  display: none;
}
...
.intro-carousel-arrow.prev:hover svg {
  transform: translateX(-4px);
}

.intro-carousel-arrow.next:hover svg {
  transform: translateX(4px);
}

@media (max-width: 1200px) {
  .intro-carousel-arrow.prev { left: -15px; }
  .intro-carousel-arrow.next { right: -15px; }
}
...
@media (max-width: 768px) {
  ...
  .intro-carousel-arrow.prev { left: -10px; }
  .intro-carousel-arrow.next { right: -10px; }
}
